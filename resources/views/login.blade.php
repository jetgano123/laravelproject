...
<![endif]-->
<link rel="https://api.w.org/" href="https://demo4.drfuri.com/razzi9/wp-json/" /><link rel="alternate" type="application/json" href="https://demo4.drfuri.com/razzi9/wp-json/wp/v2/pages/8" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="https://demo4.drfuri.com/razzi9/xmlrpc.php?rsd" />
...
</nav><h1 class="page-header__title ">My account</h1></div>
</div>
...
<p class="form-row">
<input type="hidden" id="woocommerce-login-nonce" name="woocommerce-login-nonce" value="91e53e4a3b" /><input type="hidden" name="_wp_http_referer" value="/razzi9/my-account/" /> <button type="submit" class="woocommerce-button button woocommerce-form-login__submit" name="login" value="Log in">Log in</button>
</p>
<style type="text/css">div.nsl-container[data-align="left"] {
    text-align: left;
}
...
<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
<input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="username" id="reg_username" autocomplete="username" placeholder="Username *" value="" /> </p>
<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
...
</div><label style="display: none !important;">Leave this field empty if you're human: <input type="text" name="_mc4wp_honeypot" value="" tabindex="-1" autocomplete="off" /></label><input type="hidden" name="_mc4wp_timestamp" value="1654019641" /><input type="hidden" name="_mc4wp_form_id" value="311" /><input type="hidden" name="_mc4wp_form_element_id" value="mc4wp-form-1" /><div class="mc4wp-response"></div></form></div> <a href="#" class="n-close">
...
<script>
	_stq = window._stq || [];
	_stq.push([ 'view', {v:'ext',j:'1:10.9',blog:'197487481',post:'8',tz:'0',srv:'demo4.drfuri.com'} ]);
